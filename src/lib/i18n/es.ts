...
const es = {
  ...
  'player.previous': 'Artículo anterior',
  'player.next': 'Siguiente artículo',
  'player.play': 'Reproducir',
  'player.pause': 'Pausar',
  'player.speed': 'Velocidad',
  'player.speedLabel': 'Velocidad: {rate}x',
  'player.shareArticle': 'Compartir artículo',
  'player.shareCopied': 'Enlace copiado',
  'player.queueCount': '{count} en cola',
